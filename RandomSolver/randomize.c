...
char *startSolving(char inter[100])
{
    srand(time(0));
    // char inter[100];
    // scanf("%s", &inter);
...
// int main()
// {
//     char input[100] = "500000300020100070008000009040007000000821000000600010300000800060004020009000005";
//     char *t = startSolving(input);
//     printf("%s", t);
//     // for (int i = 0; i < 81; i++)
//     //     printf("%d ", *(t + i));
// }
